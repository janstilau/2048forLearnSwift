...
//    snowflake.color = (_snowColor == nil ? [[UIColor whiteColor] CGColor] :_snowColor.CGColor);
    snowflake.color = [[UIColor purpleColor] CGColor];
    ...
    CAEmitterCell *another =  [snowflake copy];
    another.name = @"another";
    another.contents = (__bridge id)[[UIImage imageNamed:@"snow"] CGImage];
    
    // 添加粒子
    self.emitterLayer.emitterCells = @[snowflake, another];
}
